...
class DecisionNode:
    def __init__(self):
        ...
        self.safe_altitude = rospy.get_param('~safe_altitude', 0.25)
        self.safe_r = rospy.get_param('~safe_r', 0.2)
        self.height_local = rospy.get_param('~height_local', 1.2)  # 车体坐标系下的目标位置
    ...
    def is_lock(self):
        ...
        vel_vec = np.linalg.norm(self.uav_vel)
        # 解析无人机坐标
        ...
        print(horizontal_distance,vel_vec)
        # 检查高度约束和水平距离
        return (
